...
history,acc_list,val_acc_list,test_loss,test_acc = train('/s/chopin/k/grad/xiongty/PA5/train_labels.txt','/s/chopin/k/grad/xiongty/PA5/Bighorn_sheep_test_label.txt',50)
...
plt.show()
plt.savefig("Big_horn_sheepAccuracy.jpg")
