...
history,acc_list,val_acc_list,test_loss,test_acc = train('/s/chopin/k/grad/xiongty/PA5/train_labels.txt','/s/chopin/k/grad/xiongty/PA5/Raptor_test_label.txt',50)
...
plt.show()
plt.savefig("Raptor_Accuracy.jpg")
